...
#'@param weighted This parameter specifies whether to create a weighted graph for the cell-cell interaction network. If null, an unweighted graph is created, and the elements of the adjacency matrix indicate the number of edges between vertices. If true, a weighted graph is created(default: TRUE).
...
#'@usage CITMIC(GEP,weighted = TRUE,base = 10,damping=0.90,cl.cores=1)
#'@export
#'@examples
#' # Obtain the example data
#' GEP<-GetData_CITMIC("GEP")
#' # Run the function
#' \donttest{lnScore<-CITMIC(GEP,weighted = TRUE,base = 10,damping=0.90,cl.cores=1)}
